...
public class VoiceConnection(
    ...
    public val gateway: GatewayBridge,
    ...
    public val scope: CoroutineScope =
        CoroutineScope(Dispatchers.IO + SupervisorJob() + CoroutineName("kord-voice-connection[${data.guildId.value}"))
